...
.emojis .emoji-controller{
    height: 36px;
    overflow: hidden;
    margin: 0;
}
.emojis .emoji-controller li{
    float: left;
    width: 76px;
    font-size: 12px;
    line-height: 36px;
...
.emojis .emoji-controller li .active::after{
    content: '';
    width: 100%;
    height: 1px;
    background: #0689dd;
...
.emojis .emoji-container li{
    font-size: 0;
    padding: 5px;
}
.emojis .emoji-container li a{
    float: left;
    overflow: hidden;
    height: 35px;
...
.emojis .emoji-container li a:hover{
    background-color: #d8d8d8;
    border-color: #d8d8d8;
}
.emojis .emoji-container li a span{
    width: 25px;
    height: 25px;
